...
// never in the browser. Pass { requireOwner: true } for owner-only routes
// (analytics, audit logs, campaigns, site content, pricing/menu changes).
export async function requireAdmin({ requireOwner = false } = {}) {
  ...
  if (requireOwner && adminUser.role !== "owner") {
